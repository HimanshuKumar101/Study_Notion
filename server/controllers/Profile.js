...
exports.updateProfile = async (req, res) => {
  try {
    ...
    console.log("additionalDetails ID:", userDetails.additionalDetails);
    ...
    // Update the user's basic information if any changes exist
    ...
    // Retrieve the updated user with the populated profile details
...
exports.updateDisplayPicture = async (req, res) => {
  try {
    ...
    // Log the updated profile to ensure the image URL is saved
